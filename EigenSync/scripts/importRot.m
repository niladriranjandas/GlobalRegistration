function bun000Nbun045N = importRot(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BUN000NBUN045N = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   BUN000NBUN045N = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bun000Nbun045N = importfile('bun000_N_bun045_N.xf', 1, 4);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/11/20 10:44:34
...
bun000Nbun045N = [dataArray{1:end-1}];
